const en = {
  ...
  settings: {
    ...
    preferences: {
      ...
      email: 'Email notifications about policy updates and claims',
      sms: 'SMS alerts for urgent policy changes',
      push: 'Push notifications for claim status updates',
      dataAnalytics: 'Data & Analytics',
      dataSharing: 'Allow anonymous usage analytics to improve the platform',
    },
    security: {
      title: 'Security Controls',
      authentication: 'Authentication',
      twoFactor: 'Two-factor authentication (2FA) enabled',
      connectedWallets: 'Connected Wallets',
      connectedWalletsText: 'Your Stellar wallet connection is verified and secure.',
  ...
  policies: {
    ...
    hero: {
      ...
      description: 'Track live coverage, pending policy creations, and historical payouts from one responsive workspace.',
    },
    summary: {
    ...
    filters: {
      ...
      updating: 'Updating results...',
      upToDate: 'Filters are up to date.',
      searchPlaceholder: 'Search policies or oracle sources',
      searchAriaLabel: 'Search policies',
      minCoverageLabel: 'Min coverage',
      maxCoverageLabel: 'Max coverage',
      sortLabel: 'Sort',
      sortOptions: {
        date: 'Newest',
        coverage: 'Coverage',
      ...
      grid: 'Grid',
      list: 'List',
      coverageWarning: 'Minimum coverage ({min}) is greater than maximum ({max}). Values were swapped automatically; results show the full range you intended.',
    },
    simulate: {
      pending: 'Simulate pending policy',
      error: 'Simulate error state',
    },
    card: {
      saving: 'Saving…',
      ...
      coverage: 'Coverage',
      premium: 'Premium',
      dismissError: 'Dismiss error for {title}',
    },
    typeLabels: {
      weather: 'Weather',
      flight: 'Flight Delay',
